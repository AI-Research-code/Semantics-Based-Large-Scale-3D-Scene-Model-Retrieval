...
[imageclass, Ns]=read_classification_file('SceneIBR_Image_Testing_indoor.cla');

[modelclass,N]=read_classification_file('SceneIBR_Model_Testing_indoor.cla');
...
RANK_DIR='Yuan\Run2_Yuan_indoor_clean\';
