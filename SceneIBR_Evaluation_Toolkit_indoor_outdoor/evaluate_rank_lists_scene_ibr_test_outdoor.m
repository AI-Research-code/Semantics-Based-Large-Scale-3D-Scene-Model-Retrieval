...
[imageclass, Ns]=read_classification_file('SceneIBR_Image_Testing_outdoor.cla');

[modelclass,N]=read_classification_file('SceneIBR_Model_Testing_outdoor.cla');
...
RANK_DIR='Yuan\Run2_Yuan_outdoor_clean\';
